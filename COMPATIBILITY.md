...
`interoperability` module is an internal harness and is not releasable.
...
follow [`DEPRECATION.md`](DEPRECATION.md). Observable specification choices
are preserved in the [decision register](docs/specification-decisions.md).
