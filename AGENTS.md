...
- JSON:API parsing, validation, negotiation, extension, profile, and
  serialization behavior MUST remain specification-compliant and deterministic.
- Callback isolation, bounded decoding, and malformed-input handling MUST be
